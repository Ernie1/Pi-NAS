...
def get_backbone(name, **kwargs):
    models = {
        ...
        # my
        'alone_resnest50': alone_resnest50,
        }
    name = name.lower()
...
class BaseNet(nn.Module):
    ...
    def base_forward(self, x, choice_indices=None):
...
class MultiEvalModule(DataParallel):
    ...
    def __init__(self, module, nclass, device_ids=None, flip=True,
        ...
        self.flip = flip
        # my
        self.grid_evaluation = grid_evaluation
        #
        ...
        for scale in self.scales:
            ...
            # my
                ...
                if w > h:
                    ...
                    oh = int(1.0 * h * ow / w)
                # resize image to current size
                cur_img = resize_image(image, oh, ow, **self.module._up_kwargs)
